...
@Configuration
@EnableScheduling
public class OdbItAppsZmqConfig {
    private static final Logger logger = LoggerFactory.getLogger(OdbItAppsZmqConfig.class);

    @Bean
    public OdbItAppsZmqDataMapper odbItAppsZmqDataMapper() {
        return new OdbItAppsZmqDataMapper();
    }
    ...
    public ZeroMqMessageHandler zeroMqMessageHandler(
            ...
            final OdbItAppsZmqDataMapper otmbItDataMapper,
